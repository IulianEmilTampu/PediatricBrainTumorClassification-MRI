...
models_to_evaluate = [
    "/flush2/iulta54/Code/P5-PediatricBrainTumorClassification_CBTN_v1/trained_model_archive/TESTs_20231203/ResNet50_pretrained_True_SimCLR_dataset_CBTN_frozen_True_0.5_LR_5e-06_BATCH_128_AUGMENTATION_True_OPTIM_adam_SCHEDULER_exponential_MLPNODES_0_useAge_False_t101847/REPETITION_1"
]
...
for idy, model_path in enumerate(models_to_evaluate):
    ...
    for fold_idx, fold in enumerate(
        ...
        clam_classifier = model_CLAM.CLAM_SB(
            instance_feature_size=training_features.shape[1],
            gate=True,
            size_arg="small",
            dropout=False,
            k_sample=2,
