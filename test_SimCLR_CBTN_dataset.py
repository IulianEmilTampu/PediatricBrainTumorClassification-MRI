...
config = {
    "dataloader_settings": {
        ...
        "dataset_path": "/flush/iulta54/Data/CBTN_v1/T2_TUMOR_and_NO_TUMOR_SLICES",
        "classes_of_interest": ["1", "0"],
        "test_size": 0.2,
        "class_stratification": True,
        "input_size": [224, 224],
    },
    "training_settings": {
        "random_state": 29122019,
        "nbr_inner_cv_folds": 3,
    },
...
# # ### heuristics for CBTN tumor vs no tumor
# heuristic_for_subject_ID_extraction = lambda x: os.path.basename(x).split("___")[2]
...
simclr_model = train_simclr(
    ...
    ckpt_path="/flush/iulta54/P5-PedMRI_CBTN_v1/saved_models/CBTN/IET_test_20231107_t1106/SimCLR_t1106/lightning_logs/version_0/checkpoints/epoch=941-step=16956.ckpt",
    hidden_dim=128,
    max_epochs=500,
    lr=5e-3,
    temperature=0.07,
...
class LogisticRegression(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        #     optimizer, T_max=int(34 * self.hparams.max_epochs), eta_min=0, last_epoch=-1
        # )
